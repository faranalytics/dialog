...
// import { OpenAIAgentOptions } from "../agent/abstract/openai/openai_agent.js";
...
// export interface TwilioVoIPProxyOptions extends OpenAIAgentOptions<TwilioVoIP> {
...
// export abstract class TwilioVoIPProxy implements Agent {
...
//   constructor(options: TwilioVoIPProxyOptions) {
