...
export const isSpeechStartedWebSocketMessage = (message: WebSocketMessage): message is SpeechStartedWebSocketMessage => {
...
export const isInputAudioTranscriptionDeltaWebSocketMessage = (message: WebSocketMessage): message is InputAudioTranscriptionDeltaWebSocketMessage => {
...
export const isConversationItemCreatedWebSocketMessage = (message: WebSocketMessage): message is ConversationItemCreatedWebSocketMessage => {
